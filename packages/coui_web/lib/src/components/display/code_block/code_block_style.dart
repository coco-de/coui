...
/// Styling interface for CodeBlock components.
abstract interface class CodeBlockStyling implements Styling {}

/// CodeBlock style class using Tailwind CSS.
class CodeBlockStyle implements CodeBlockStyling {
