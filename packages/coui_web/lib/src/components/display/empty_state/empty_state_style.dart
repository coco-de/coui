...
/// Styling interface for EmptyState components.
abstract interface class EmptyStateStyling implements Styling {}

/// EmptyState style class using Tailwind CSS.
class EmptyStateStyle implements EmptyStateStyling {
