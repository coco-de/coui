...
/// Styling interface for Banner components.
abstract interface class BannerStyling implements Styling {}

/// Banner style class using Tailwind CSS.
class BannerStyle implements BannerStyling {
  const BannerStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
