...
/// with the coui_flutter form system and provides convenient methods for
...
///
/// [Button] is the foundational interactive widget in the coui_flutter design system,
...
class ButtonState<T extends Button> extends State<T> {
  ...
  void didChangeDependencies() {
    ...
    final overrideData = Data.maybeOf<ButtonStyleOverrideData>(context);
  ...
  void didUpdateWidget(T oldWidget) {
    ...
    if (widget.style != oldWidget.style) {
      final overrideData = _overrideData;
      if (overrideData != null) {
        _style = widget.style.copyWith(
          decoration: overrideData.decoration,
          mouseCursor: overrideData.mouseCursor,
...
class ComponentThemeButtonStyle<T extends ButtonTheme>
  ...
  T? find(BuildContext context) {
    return ComponentTheme.maybeOf(context);
  }
  ...
  Decoration _resolveDecoration(BuildContext context, Set<WidgetState> states) {
    final resolved = fallback.decoration(context, states);
  ...
  TextStyle _resolveTextStyle(BuildContext context, Set<WidgetState> states) {
    final resolved = fallback.textStyle(context, states);
...
class ButtonGroup extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final children = List<Widget>.of(this.children);
        ...
        children[i] = ButtonStyleOverride(
          decoration: (context, states, value) {
            if (value is BoxDecoration) {
              ...
              final borderRadius = value.borderRadius;
