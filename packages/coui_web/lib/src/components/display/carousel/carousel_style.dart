...
/// Styling interface for Carousel components.
abstract interface class CarouselStyling implements Styling {}

/// Carousel style class using Tailwind CSS.
class CarouselStyle implements CarouselStyling {
  const CarouselStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
