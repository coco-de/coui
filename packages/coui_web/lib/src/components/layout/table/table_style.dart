...
/// Styling interface for Table components.
abstract interface class TableStyling implements Styling {}

/// Table style class using Tailwind CSS.
class TableStyle implements TableStyling {
  const TableStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
