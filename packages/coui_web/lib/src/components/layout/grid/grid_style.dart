...
/// Styling interface for Grid components.
abstract interface class GridStyling implements Styling {}

/// Grid style class using Tailwind CSS.
class GridStyle implements GridStyling {
  const GridStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
