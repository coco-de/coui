...
/// Styling interface for Calendar components.
abstract interface class CalendarStyling implements Styling {}

/// Calendar style class using Tailwind CSS.
class CalendarStyle implements CalendarStyling {
  const CalendarStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
