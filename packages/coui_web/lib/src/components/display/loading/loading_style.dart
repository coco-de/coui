...
/// Styling interface for Loading components.
abstract interface class LoadingStyling implements Styling {}

/// Loading style class using Tailwind CSS.
class LoadingStyle implements LoadingStyling {
  const LoadingStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
