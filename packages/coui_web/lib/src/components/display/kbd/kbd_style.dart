...
/// Styling interface for Kbd components.
abstract interface class KbdStyling implements Styling {}

/// Kbd style class using Tailwind CSS.
class KbdStyle implements KbdStyling {
  const KbdStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
