...
/// Styling interface for AspectRatio components.
abstract interface class AspectRatioStyling implements Styling {}

/// AspectRatio style class using Tailwind CSS.
class AspectRatioStyle implements AspectRatioStyling {
