...
/// Styling interface for HoverCard components.
abstract interface class HoverCardStyling implements Styling {}

/// HoverCard style class using Tailwind CSS.
class HoverCardStyle implements HoverCardStyling {
