...
/// Styling interface for Stat components.
abstract interface class StatStyling implements Styling {}

/// Stat style class using Tailwind CSS.
class StatStyle implements StatStyling {
  const StatStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
