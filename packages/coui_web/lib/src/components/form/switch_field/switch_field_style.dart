...
/// Styling interface for SwitchField components.
abstract interface class SwitchFieldStyling implements Styling {}

/// SwitchField style class using Tailwind CSS.
class SwitchFieldStyle implements SwitchFieldStyling {
