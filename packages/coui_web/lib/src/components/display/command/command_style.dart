...
/// Styling interface for Command components.
abstract interface class CommandStyling implements Styling {}

/// Command style class using Tailwind CSS.
class CommandStyle implements CommandStyling {
  const CommandStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
