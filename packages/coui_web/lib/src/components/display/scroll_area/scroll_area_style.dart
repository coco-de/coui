...
/// Styling interface for ScrollArea components.
abstract interface class ScrollAreaStyling implements Styling {}

/// ScrollArea style class using Tailwind CSS.
class ScrollAreaStyle implements ScrollAreaStyling {
