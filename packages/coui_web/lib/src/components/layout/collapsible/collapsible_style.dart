...
/// Styling interface for Collapsible components.
abstract interface class CollapsibleStyling implements Styling {}

/// Collapsible style class using Tailwind CSS.
class CollapsibleStyle implements CollapsibleStyling {
