...
/// Styling interface for Timeline components.
abstract interface class TimelineStyling implements Styling {}

/// Timeline style class using Tailwind CSS.
class TimelineStyle implements TimelineStyling {
  const TimelineStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
