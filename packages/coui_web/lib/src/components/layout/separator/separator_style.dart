...
/// Styling interface for Separator components.
abstract interface class SeparatorStyling implements Styling {}

/// Separator style class using Tailwind CSS.
class SeparatorStyle implements SeparatorStyling {
