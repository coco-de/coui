...
/// Styling interface for Link components.
abstract interface class LinkStyling implements Styling {}

/// Link style class using Tailwind CSS.
class LinkStyle implements LinkStyling {
  const LinkStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
