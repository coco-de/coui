...
/// Styling interface for Resizable components.
abstract interface class ResizableStyling implements Styling {}

/// Resizable style class using Tailwind CSS.
class ResizableStyle implements ResizableStyling {
