...
/// Styling interface for Divider components.
abstract interface class DividerStyling implements Styling {}

/// Divider style class using Tailwind CSS.
class DividerStyle implements DividerStyling {
  const DividerStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
