    ...
    return RadioGroup(
      ...
      child: const Row(
        ...
        children: [
          RadioCard(
            value: 1,
            child: Basic(title: Text('8-core CPU'), content: Text('32 GB RAM')),
          ),
          RadioCard(
            value: 2,
            child: Basic(title: Text('6-core CPU'), content: Text('24 GB RAM')),
          ),
          RadioCard(
            value: 3,
            child: Basic(title: Text('4-core CPU'), content: Text('16 GB RAM')),
          ),
        ],
      ).gap(12),
    );
