          ...
          Accordion(
            items: [
              const AccordionItem(
                ...
                content: Text(
                  'Yes, it does. You can use GoRouter with coui_flutter. ',
                ),
              ),
              const AccordionItem(
                trigger: AccordionTrigger(
          ...
          Column(
            ...
            children: [
              ...
              const Text('pub.dev: ')
                  .thenButton(
                    onPressed: () {
                      launchUrlString('https://pub.dev/packages/coui_flutter');
                    },
                    child: const Text('https://pub.dev/packages/coui_flutter'),
                  )
                  .li(),
              const Text('Discord: ')
                  .thenButton(
