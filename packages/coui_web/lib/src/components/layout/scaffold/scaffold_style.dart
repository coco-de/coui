...
/// Styling interface for Scaffold components.
abstract interface class ScaffoldStyling implements Styling {}

/// Scaffold style class using Tailwind CSS.
class ScaffoldStyle implements ScaffoldStyling {
  const ScaffoldStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
