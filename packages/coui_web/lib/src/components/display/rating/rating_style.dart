...
/// Styling interface for Rating components.
abstract interface class RatingStyling implements Styling {}

/// Rating style class using Tailwind CSS.
class RatingStyle implements RatingStyling {
  const RatingStyle(
    this.cssClass, {
    this.modifiers,
    required this.type,
