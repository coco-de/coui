      ...
      child: Column(
        ...
        children: [
          ...
          const SelectableText(
            'A comprehensive guide to managing state in coui_flutter.',
          ).lead(),
          const SelectableText(
            'In Flutter, everything is a widget, including where your data is stored.',
          ).p(),
          const SelectableText(
            'Internally, coui_flutter has its own state management system. '
            'Although if you are already using a state management system, '
            'you can continue to use it with coui_flutter.',
          ).p(),
          const SelectableText(
            'Passing Data to the Children',
          ).h2().anchored(keyPassingDataToChildren),
          const SelectableText(
          ...
          ).h2().anchored(keyGettingDataFromTheChild),
          ...
          const SelectableText(
            'MultiData Widget',
          ).h2().anchored(keyMultiDataWidget),
          const SelectableText(
          ...
          ).h2().anchored(keyPassingStateAsAController),
          const SelectableText(
          ...
          const SelectableText(
            'ModelListenable',
          ).h2().anchored(keyModelListenable),
          const SelectableText(
